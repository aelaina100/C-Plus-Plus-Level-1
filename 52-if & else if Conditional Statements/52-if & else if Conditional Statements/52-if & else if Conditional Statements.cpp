...
/*
   -------------------------------------------------------------------------
   Why Functions Are Preferred Over Printing Procedures for conditional logic
   -------------------------------------------------------------------------

   ❌ Less Preferred (Procedure with cout inside):

       void EvaluateGrade(float grade)
       {
           if (grade >= 90)
               cout << "A";
       }

   ✅ Preferred (Function that returns a value):

       char gradeLetter = EvaluateGrade(grade);
       cout << gradeLetter;
