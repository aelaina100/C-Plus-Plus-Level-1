...
/* Structures: 
 ...
 and each represent a member of the structure ( = a member of the created data type).
        ...
        each other. Therefore, I LUMP THESE RELATED VARIABLES TOGETHER under a structure name (data type).

        - A person's address consists of street number, street name, postal code, apartment number, 
          city, provice, & country. 
          Therefore, I can create a datatype (structure) and call it 'Adress' (or name it anything else)
