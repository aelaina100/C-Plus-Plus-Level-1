...
int main()
{
	...
	enMaritalStatus MaritalStatus = enMaritalStatus::Single; // stores 0 that is under the label ::Single
	enFavouriteColor FavouriteColor = enFavouriteColor::Blue; // stores 9 that is under the label ::Blue
...
//// brainstorming: Is it possible to couple the enumeration concept with user input ? (Will be explained in future lectures).
