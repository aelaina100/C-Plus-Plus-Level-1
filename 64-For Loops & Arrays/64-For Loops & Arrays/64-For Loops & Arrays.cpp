...
/*
 ...
 Even though some compilers may accept this as a non-standard extension,
 it is not valid C++ and should NOT be relied upon.

 Therefore, in standard C++, an array cannot be declared first
 ...
 /*
 Note:
 Although this is NOT allowed with built-in arrays in standard C++,
