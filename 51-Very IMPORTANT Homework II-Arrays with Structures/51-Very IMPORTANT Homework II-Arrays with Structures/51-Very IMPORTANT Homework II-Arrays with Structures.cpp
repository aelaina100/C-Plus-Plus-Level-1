...
{
	ReadPersonalInfo(PersonalInfo[0]); // passing the first element in the array. It will be populated with an entire record of the first person.
	ReadPersonalInfo(PersonalInfo[1]); //passing the second element in the array. It will be populated with an entire record of the second person.
}
...
{
	PrintPersonalInfo(PersonalInfo[0]);
	PrintPersonalInfo(PersonalInfo[1]);
}
