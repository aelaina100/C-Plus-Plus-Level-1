 ...
 */
 ...
 ====================================================
  ...
  Conclusion:
  - The outer for-loop starts from i = 1 and increments up to 8 (simply becasue of B)
  ...
  Analysis:
  A- Total number of rows = 8
  B- Each row’s content is SHRINKING (simply becasue of B)
  - The inner loop is still DEPENDENT on the outer loop variable (i)

  Conclusion:
  - The outer for-loop starts from i = 8 and decrements down to 1
  - The inner for-loop runs from 1 up to i
