...
/* Arrays: 
   ...
   An array can be of any fundemental data type:
         an integer, float, double, wchar_t, char, string, bool.

 If you remember- a string is an array of characters, implying that we can access any of these characters:

    String x = "Ana Ku";    // x is an array of characters 
 ...
 For example, String is an array that stores multiple characters.

 An array can be of any fundemental data type.
 Such as an int array storing students' marks.
 Or a double array, a float array, a String array, and much more that we will see as we progress.
...
/* How it works in memory: 
 ...
 Array Members →     x[0]     x[1]     x[2]     x[3]     x[4]
                  ...
                  ├────────┼────────┼────────┼────────┼────────┤                                                          ▼         
                  │    0   │    1   │    2   │    3   │    4   │   ← Immediately indexing the memory spaces   ◀─◀──◀──◀─◀ ▼                       
                  └────────┴────────┴────────┴────────┴────────┘
