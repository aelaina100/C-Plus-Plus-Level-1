...
/*
       *********************************  🎯 Perfect Summary (Expanded)   *********************************
        ...
        ✅ Pass-by-reference (C++):
         ...
         . Since the parameter is passed by reference, any change inside the function directly affects the same memory location, 
         ...
         - Therefore, the function does not receive a copy of the value (e.g., it does not create a new Num1 that holds its own copy of 1000).
...
/***********************************************************************************************************************************************
                               Final, Correct, Professional Version (Recommended)
