 ...
 ** A-  A For-Loop such as: */
  ...
  */
  ...
  /* =================================================================================================
   ** B – WHILE-LOOP UNIVERSAL INPUT UTILITIES
   =================================================================================================

   PURPOSE:
   --------
   Safely initialize variables via user input WITH IMMEDIATE validation.

   WHY WHILE-LOOP?
   ---------------
   • The number of iterations depends on the user's input.
   • The iteration count is NOT known at compile-time.
   • Therefore, while-loop is the correct construct.
