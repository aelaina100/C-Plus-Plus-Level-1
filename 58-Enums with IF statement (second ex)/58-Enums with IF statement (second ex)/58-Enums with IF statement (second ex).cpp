...
/*Solution:
  If there is an indication that any number used in the program represents something,
  then the FIRST STEP IN CODING THE PROGRAM, is creating an enum user-defined data type
